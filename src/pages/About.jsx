    ...
    <div className="bg-gradient-to-r from-slate-900 to-purple-950 w-full flex flex-col overflow-hidden">
      ...
      <div className="min-h-screen flex flex-col justify-center items-center ">
        {/* Header */}
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-sky-200">
            About
          </span>{" "}
        ...
        <div className="max-w-9/12 p-10 flex justify-between items-center gap-7" >
          ...
          <div className="max-w-6xl p-5" >
            ...
            <h1 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-red-800">Building Full Stack  with a strong product mindset.</h1>
