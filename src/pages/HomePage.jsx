...
const HomePage = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen overflow-x-hidden bg-gradient-to-r from-slate-900 to-purple-950 bg-cover bg-center bg-no-repeat">
      ...
      <div className="flex items-center justify-around overflow-x-hidden p-10 w-auto min-w-5xl">
        ...
        <div className="flex-col p-4 space-y-2 text-left items-center w-auto min-w-3xl">
          ...
          <p className="text-neutral-400 font-[poppins] text-xl max-w-2xl w-auto p-4">
  Full Stack Developer focused on creating responsive and scalable web applications. Continuously learning and building projects using Java, Spring Boot, React.js, and MySQL.
          </p>
