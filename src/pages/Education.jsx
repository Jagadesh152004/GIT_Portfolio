...
{/* Item1-Content */}
      ...
      shadow-[0_0_25px_#22d3ee] transition-all hover:scale-110 duration-600 ease-in-out cursor-pointer hover:-translate-y-2
...
hover:shadow-[0_0_50px_#22d3ee]">
      ...
      <div className="w-md bg-black border-2 border-cyan-400
      rounded-4xl p-8 text-center
      shadow-[0_0_25px_#22d3ee] transition-all hover:scale-110 duration-600 ease-in-out cursor-pointer hover:-translate-y-2 hover:shadow-[0_0_50px_#22d3ee]">
      ...
      w-5 h-5 bg-cyan-400 rounded-full
      shadow-[0_0_20px_#22d3ee]
      -translate-x-1/2 transition-all hover:scale-110 duration-600 ease-in-out cursor-pointer hover:-translate-y-2 hover:shadow-[0_0_50px_#22d3ee]">
      </div>
