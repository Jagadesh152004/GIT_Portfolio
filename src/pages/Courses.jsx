      ...
      <div className="min-h-screen p-20">
        ...
        <div className="min-w-5xl w-auto relative">
          ...
          <div className="relative flex justify-start mb-5 p-5">
            {/* Item1-Content */}
            <div
              className="w-md bg-black border-2 border-cyan-400 rounded-4xl p-8 text-center shadow-[0_0_25px_#22d3ee] transition-all hover:scale-110 duration-600 ease-in-out cursor-pointer hover:-translate-y-2
hover:shadow-[0_0_50px_#22d3ee]"
      ...
      -translate-x-1/2"
          ...
          <div className="relative flex justify-end mt-2 mb-5 p-5">
            {/* Item-2 Content */}
            <div
              className="w-md bg-black border-2 border-cyan-400
