...
{/* Item1-Content */}
      ...
      -translate-x-1/2">
        ...
        <div className="flex justify-center items-center w-50 gap-8">
          ...
          smooth={true}
          duration={800}
          className="text-black font-[poppins] text-xs font-semibold bg-amber-400 p-4 rounded-xl animate-bounce duration-1000"> 
          Go back</Link>
          </div>
